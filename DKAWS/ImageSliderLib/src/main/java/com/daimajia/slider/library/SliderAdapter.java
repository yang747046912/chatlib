...
public class SliderAdapter extends PagerAdapter implements BaseSliderView.ImageLoadListener{
    ...
    private boolean canCycleSlip = true;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (b==null){
            throw new RuntimeException("Slider item must not null");
        }
        View v = b.getView();
        container.addView(v);
        return v;
    ...
    public boolean isCanCycleSlip() {
        return canCycleSlip;
    }

    public void setCanCycleSlip(boolean canCycleSlip) {
        this.canCycleSlip = canCycleSlip;
    }
}
