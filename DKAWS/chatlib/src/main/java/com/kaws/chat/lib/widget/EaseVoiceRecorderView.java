...
import com.kaws.chat.lib.model.EaseVoiceRecorder;
import com.kaws.chat.lib.utils.EaseCommonUtils;
import com.kaws.chat.lib.widget.chatrow.EaseChatRowVoicePlayClickListener;
...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    public void showMoveUpToCancelHint() {
        recordingHint.setText(context.getString(R.string.move_up_to_cancel));
        recordingHint.setTextColor(context.getResources().getColor(R.color.chat_msg_color));
        recordingHint.setBackgroundColor(Color.TRANSPARENT);
    }
