...
import com.kaws.chat.lib.domain.EaseEmojiconGroupEntity;
import com.kaws.chat.lib.model.EaseDefaultEmojiconDatas;
import com.kaws.chat.lib.utils.EaseSmileUtils;
import com.kaws.chat.lib.widget.EaseChatExtendMenu.EaseChatExtendMenuItemClickListener;
import com.kaws.chat.lib.widget.EaseChatPrimaryMenuBase.EaseChatPrimaryMenuListener;
import com.kaws.chat.lib.widget.emojicon.EaseEmojiconMenu;
import com.kaws.chat.lib.widget.emojicon.EaseEmojiconMenuBase;
import com.kaws.chat.lib.widget.emojicon.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
...
public class EaseChatInputMenu extends LinearLayout {
    ...
    public List<EaseEmojicon> getData() {
        int peoplelength = People.DATA.length;
        List<EaseEmojicon> emojiconList = new ArrayList<>();
        for (int i = 0; i < peoplelength; i++) {
            int key = EmojiconHandler.sEmojisMap.keyAt(i);
            int id = EmojiconHandler.sEmojisMap.get(key);
            emojiconList.add(new EaseEmojicon(id, EaseEmojicon.newEmojiText(key)));
        }
        return emojiconList;
    }
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (emojiconMenu == null) {
            ...
            if (emojiconGroupList == null) {
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.ee_1, getData()));
            }
