 ...
 */
public class KAWSrefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public KAWSrefreshHeader(Context context) {
        this(context, null);
    }

    public KAWSrefreshHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public KAWSrefreshHeader(Context context, AttributeSet attrs, int defStyleAttr) {
