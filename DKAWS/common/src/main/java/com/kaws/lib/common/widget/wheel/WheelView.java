...
package com.kaws.lib.common.widget.wheel;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xeeE9E9E9, 0x55E9E9E9, 0x00E9E9E9 };
	
//	private int[] SHADOWS_COLORS = new int[] { 0xffFFB6C1, 0xefFFC0CB,0x00DC143C };

	/** Top and bottom items offset (to hide that) */
	private static final int ITEM_OFFSET_PERCENT = 2;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / Remarked by wulianghuan 2014-11-27 浣跨敤鑷繁鐨勭敾绾匡紝鑰屼笉鏄弿杈� Rect rect = new
		...
		// Rect r = new Rect(0, center - offset, getWidth(), center + offset);
		// Paint paint = new Paint();
		// paint.setColor(Color.parseColor("#ededed"));
		//
		// // 涓婄嚎
		// canvas.drawLine(r.left, r.top, r.width() - 1, r.top, paint);
		// // 涓嬬嚎
		// canvas.drawLine(r.left, r.bottom, r.width() - 1, r.bottom, paint);
		//
		// // //宸︾嚎
		// // canvas.drawLine(r.left, r.top, r.left, r.height()-1, paint);
		// //
		// // //鍙崇嚎
		// // canvas.drawLine(r.right, r.top, r.right, r.height()-1, paint);
